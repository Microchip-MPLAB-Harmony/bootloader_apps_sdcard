...
{"0": {
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "SDCARD Bootloader",
    "title": "SDCARD Bootloader",
    "content": "This example application shows how to use the File System Bootloader Library to bootload an application using SDCARD protocol. Bootloader Application . | This is a bootloader application which resides from . | The starting location of the flash memory region for SAM devices | The starting location of the Boot flash memory region for PIC32MZ devices | The starting location of Program Flash memory for PIC32MK and PIC32MX devices | . | It uses the Harmony 3 File System Framework to receive the application binary from a sdcard | It calls the bootloader_Tasks() function which receives application to be programmed into flash memory from a sdcard | It glows an LED once bootloader firmware is running | Trigger Methods . | It uses the On board Switch as bootloader trigger pin to force enter the bootloader at reset of device | It checks for bootloader request pattern (0x5048434D) from the starting 16 Bytes of RAM to force enter bootloader at reset of device | . | . Test Application . | This is a test application which resides from . | The end of bootloader size in device flash memory for SAM devices | The end of bootloader size in Program Flash memory for PIC32MK and PIC32MX devices | The start of Program Flash memory for PIC32MZ devices | . | It will be loaded into flash memory by bootloader application | It blinks an LED and provides console output | It uses the On board Switch to trigger the bootloader from firmware . | Once the switch is pressed it loads first 16 bytes of RAM with bootloader request pattern (0x5048434D) and resets the device | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/readme.html#sdcard-bootloader",
    "relUrl": "/apps/sdcard_bootloader/readme.html#sdcard-bootloader"
  },"2": {
    "doc": "SDCARD Bootloader",
    "title": "Development Kits",
    "content": "The following table provides links to documentation on how to build and run SDCARD bootloader on different development kits . | Development Kit | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . | SAM E54 Xplained Pro Evaluation Kit | . | SAM E70 Xplained Ultra Evaluation Kit | . | SAM L22 Xplained Pro Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/readme.html#development-kits",
    "relUrl": "/apps/sdcard_bootloader/readme.html#development-kits"
  },"3": {
    "doc": "SDCARD Bootloader",
    "title": "SDCARD Bootloader",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/readme.html",
    "relUrl": "/apps/sdcard_bootloader/readme.html"
  },"4": {
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded",
    "relUrl": "/apps/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded"
  },"5": {
    "doc": "Application Configurations",
    "title": "Application Configurations",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application.html",
    ...
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html#configuring-an-application-to-be-bootloaded-for-mips-based-mcus",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html#linker-configurations-for-the-application-to-be-bootloaded",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html#setting-up-the-application-linker-script",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html#additional-settings-optional",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html#mplab-x-settings",
    ...
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_pic32m.html",
    ...
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_sam.html#configuring-an-application-to-be-bootloaded-for-cortex-m-based-mcus",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_sam.html#application-settings-in-mcc-system-configuration",
    "relUrl": "/apps/docs/readme_configure_application_sam.html#application-settings-in-mcc-system-configuration"
  },"14": {
    "doc": "Application Configurations for CORTEX-M based MCUs",
    "title": "MPLAB X Settings",
    "content": ". | Specifying post build option to automatically generate the binary file from hex file once the build is complete . \${MP_CC_DIR}/xc32-objcopy -I ihex -O binary \${DISTDIR}/\${PROJECTNAME}.\${IMAGE_TYPE}.hex \${DISTDIR}/\${PROJECTNAME}.\${IMAGE_TYPE}.bin . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_sam.html#mplab-x-settings",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_sam.html#additional-settings-optional",
    ...
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/docs/readme_configure_application_sam.html",
    ...
    "title": "Building and Running the SDCARD Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#building-and-running-the-sdcard-bootloader-applications",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#building-and-running-the-sdcard-bootloader-applications"
  },"18": {
    "doc": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the application within the repository is apps/sdcard_bootloader/ . To build the application, refer to the following table and open the project using its IDE. Bootloader Application . | Project Name | Description | . | bootloader/firmware/pic32mz_das_sk.X | MPLABX Project for PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . Test Application . | Project Name | Description | . | test_app/firmware/pic32mz_das_sk.X | MPLABX Project for PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#downloading-and-building-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#downloading-and-building-the-application"
  },"19": {
    "doc": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "title": "Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "content": ". | Connect a micro USB cable to the UART-USB port J5 | For programming, connect a micro USB cable to the USB Debug port J19 | Use the micro sdcard slot J10 of the device to insert a micro sdcard | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#setting-up-pic32mz-embedded-graphics-with-stacked-dram-da-starter-kit-crypto",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#setting-up-pic32mz-embedded-graphics-with-stacked-dram-da-starter-kit-crypto"
  },"20": {
    "doc": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "title": "Running the Application",
    "content": ". | Open the test application project test_app/firmware/pic32mz_das_sk.X in the IDE | Build the project to generate the binary (Do not program the binary) | Open the bootloader project bootloader/firmware/pic32mz_das_sk.X in the IDE | Build and program the application using the IDE . | LED1 will be Turned On once programming is completed and bootloader starts running . | Open the Terminal application (Ex.:Tera Term) on the computer to get test application messages through UART once bootloaded | Configure the serial port settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Copy the generated application binary file to a micro sdcard from the Host PC . | &lt;harmony3_path&gt;/bootloader_apps_sdcard/apps/sdcard_bootloader/test_app/firmware/pic32mz_das_sk.X/dist/pic32mz_das_sk/production/pic32mz_das_sk.X.production.bin | . | Rename the copied application binary file to image.bin . | Insert the micro sdcard with the application binary image.bin to the micro sdcard slot on the device . | Once the application is successfully programmed LED3 should start blinking and you should see below output on the console . | Remove the micro sdcard from the sdcard slot . | Press and hold the Switch SW1 to trigger Bootloader from test application and you should see below output . | Repeat Steps 10-12 once and jump to Step-15 . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 13 | . | Press and hold the Switch SW1 and then press Reset button or Power cycle the device to force trigger bootloader at startup | Repeat Steps 10-12 once . | This step is to verify whether bootloader is triggered by switch press at reset | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#running-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#running-the-application"
  },"21": {
    "doc": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#additional-steps-optional",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html#additional-steps-optional"
  },"22": {
    "doc": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "title": "Building and Running on PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto)",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_pic32mz_das_sk.html"
  },"23": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Running the SDCARD Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-sdcard-bootloader-applications",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-sdcard-bootloader-applications"
  },"24": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application"
  },"25": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Setting up SAM E54 Xplained Pro Evaluation Kit",
    "content": ". | Connect the Debug USB port on the board to the computer using a micro USB cable | Use the sdcard slot at the bottom of the device to insert a sdcard | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit"
  },"26": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Running the Application",
    "content": ". | Open the test application project test_app/firmware/sam_e54_xpro.X in the IDE | Build the project to generate the binary (Do not program the binary) | Open the bootloader project bootloader/firmware/sam_e54_xpro.X in the IDE | Build and program the application using the IDE . | LED0 will be Turned On once programming is completed and bootloader starts running . | Open the Terminal application (Ex.:Tera Term) on the computer to get test application messages through UART once bootloaded | Configure the serial port settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Copy the generated application binary file to a sdcard from the Host PC . | &lt;harmony3_path&gt;/bootloader_apps_sdcard/apps/sdcard_bootloader/test_app/firmware/sam_e54_xpro.X/dist/sam_e54_xpro/production/sam_e54_xpro.X.production.bin | . | Rename the copied application binary file to image.bin . | Insert the sdcard with the application binary image.bin to the sdcard slot on the device . | Once the application is successfully programmed LED0 should start blinking and you should see below output on the console . | Remove the sdcard from the sdcard slot . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Repeat Steps 10-12 once and jump to Step-15 . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 13 | . | Press and hold the Switch SW0 and then press Reset button or Power cycle the device to force trigger bootloader at startup | Repeat Steps 10-12 once . | This step is to verify whether bootloader is triggered by switch press at reset | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#running-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#running-the-application"
  },"27": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": ". | To bootload any other application refer to Application Configurations . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#additional-steps-optional",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html#additional-steps-optional"
  },"28": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e54_xpro.html"
  },"29": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Building and Running the SDCARD Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#building-and-running-the-sdcard-bootloader-applications",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#building-and-running-the-sdcard-bootloader-applications"
  },"30": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#downloading-and-building-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#downloading-and-building-the-application"
  },"31": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Setting up SAM E70 Xplained Ultra Evaluation Kit",
    "content": ". | Connect the Debug USB port on the board to the computer using a micro USB cable | Use the micro sdcard slot at the bottom of the device to insert a micro sdcard | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#setting-up-sam-e70-xplained-ultra-evaluation-kit",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#setting-up-sam-e70-xplained-ultra-evaluation-kit"
  },"32": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Running the Application",
    "content": ". | Open the test application project test_app/firmware/sam_e70_xult.X in the IDE | Build the project to generate the binary (Do not program the binary) | Open the bootloader project bootloader/firmware/sam_e70_xult.X in the IDE | Build and program the application using the IDE . | LED1 will be Turned On once programming is completed and bootloader starts running . | Open the Terminal application (Ex.:Tera Term) on the computer to get test application messages through UART once bootloaded | Configure the serial port settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Copy the generated application binary file to a micro sdcard from the Host PC . | &lt;harmony3_path&gt;/bootloader_apps_sdcard/apps/sdcard_bootloader/test_app/firmware/sam_e70_xult.X/dist/sam_e70_xult/production/sam_e70_xult.X.production.bin | . | Rename the copied application binary file to image.bin . | Insert the micro sdcard with the application binary image.bin to the micro sdcard slot on the device . | Once the application is successfully programmed LED1 should start blinking and you should see below output on the console . | Remove the micro sdcard from the sdcard slot . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Repeat Steps 10-12 once and jump to Step-15 . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 13 | . | Press and hold the Switch SW0 and then press Reset button or Power cycle the device to force trigger bootloader at startup | Repeat Steps 10-12 once . | This step is to verify whether bootloader is triggered by switch press at reset | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#running-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#running-the-application"
  },"33": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": ". | To bootload any other application refer to Application Configurations . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#additional-steps-optional",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html#additional-steps-optional"
  },"34": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_e70_xult.html"
  },"35": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Building and Running the SDCARD Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#building-and-running-the-sdcard-bootloader-applications",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#building-and-running-the-sdcard-bootloader-applications"
  },"36": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#downloading-and-building-the-application"
  },"37": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Setting up SAM L22 Xplained Pro Evaluation Kit",
    "content": ". | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect a IO1 Xplained Pro Extension Kit to the EXT1 connector of SAM L22 Xplained Pro Evaluation Kit | Use the micro sdcard slot of the IO1 Xplained Pro Extension Kit to insert a micro sdcard | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#setting-up-sam-l22-xplained-pro-evaluation-kit",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#setting-up-sam-l22-xplained-pro-evaluation-kit"
  },"38": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Running the Application",
    "content": ". | Open the test application project test_app/firmware/sam_l22_xpro.X in the IDE | Build the project to generate the binary (Do not program the binary) | Open the bootloader project bootloader/firmware/sam_l22_xpro.X in the IDE | Build and program the application using the IDE . | LED0 will be Turned On once programming is completed and bootloader starts running . | Open the Terminal application (Ex.:Tera Term) on the computer to get test application messages through UART once bootloaded | Configure the serial port settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Copy the generated application binary file to a micro sdcard from the Host PC . | &lt;harmony3_path&gt;/bootloader_apps_sdcard/apps/sdcard_bootloader/test_app/firmware/sam_l22_xpro.X/dist/sam_l22_xpro/production/sam_l22_xpro.X.production.bin | . | Rename the copied application binary file to image.bin . | Insert the micro sdcard with the application binary image.bin to the micro sdcard slot of the IO1 Xplained Pro Extension Kit . | Once the application is successfully programmed LED0 should start blinking and you should see below output on the console . | Remove the micro sdcard from the sdcard slot . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Repeat Steps 10-12 once and jump to Step-15 . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 13 | . | Press and hold the Switch SW0 and then press Reset button or Power cycle the device to force trigger bootloader at startup | Repeat Steps 10-12 once . | This step is to verify whether bootloader is triggered by switch press at reset | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#running-the-application",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#running-the-application"
  },"39": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": ". | To bootload any other application refer to Application Configurations . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#additional-steps-optional",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html#additional-steps-optional"
  },"40": {
    "doc": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "title": "Building and Running on SAM L22 Xplained Pro Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html",
    "relUrl": "/apps/sdcard_bootloader/docs/readme_sam_l22_xpro.html"
  },"41": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"42": {
    "doc": "Release notes",
    "title": "SD Card Bootloader Applications Release v3.1.0",
    "content": "Development kit and demo application support . | The following table provides bootloader demo applications available for different development kits. | Product Family | Development Kits | SDCARD | . | SAM L22 | SAM L22 Xplained Pro Evaluation Kit | Yes | . | SAM D5x/E5x | SAM E54 Xplained Pro Evaluation Kit | Yes | . | SAM E70/S70/V70/V71 | SAM E70 Xplained Ultra Evaluation Kit | Yes | . | PIC32MZ DA | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | Yes | . | . Known Issues . | N/A | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® XC32 C/C++ Compiler v4.10 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.17 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#sd-card-bootloader-applications-release-v310",
    "relUrl": "/release_notes.html#sd-card-bootloader-applications-release-v310"
  },"43": {
    "doc": "Release notes",
    "title": "SD Card Bootloader Applications Release v3.0.3",
    "content": ". | New File System Bootloader component is added in Bootloader v3.5.0 release. Reconfigured all SDCARD bootloader applications to use the new File System Bootloader component in MHC | . Known Issues . | No changes from v3.0.0 | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® XC32 C/C++ Compiler v3.00 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony 3 Launcher v3.6.4 and above. | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#sd-card-bootloader-applications-release-v303",
    "relUrl": "/release_notes.html#sd-card-bootloader-applications-release-v303"
  },"44": {
    "doc": "Release notes",
    "title": "SD Card Bootloader Applications Release v3.0.2",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#sd-card-bootloader-applications-release-v302",
    "relUrl": "/release_notes.html#sd-card-bootloader-applications-release-v302"
  },"45": {
    "doc": "Release notes",
    "title": "SD Card Bootloader Applications Release v3.0.1",
    ...
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#sd-card-bootloader-applications-release-v301",
    "relUrl": "/release_notes.html#sd-card-bootloader-applications-release-v301"
  },"46": {
    "doc": "Release notes",
    "title": "SD Card Bootloader Applications Release v3.0.0",
    "content": "New Features . | This release introduces support of . | SD Card Bootloader Applications for SAM and PIC32M family of 32-bit microcontrollers. | . | . Development kit and demo application support . | The following table provides bootloader demo applications available for different development kits. | Product Family | Development Kits | SDCARD | . | SAM L22 | SAM L22 Xplained Pro Evaluation Kit | Yes | . | SAM D5x/E5x | SAM E54 Xplained Pro Evaluation Kit | Yes | . | SAM E70/S70/V70/V71 | SAM E70 Xplained Ultra Evaluation Kit | Yes | . | PIC32MZ DA | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | Yes | . | . Known Issues . | N/A | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® XC32 C/C++ Compiler v2.41 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.5.0 and above. | . | . ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html#sd-card-bootloader-applications-release-v300",
    "relUrl": "/release_notes.html#sd-card-bootloader-applications-release-v300"
  },"47": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/release_notes.html",
    "relUrl": "/release_notes.html"
  },"48": {
    "doc": "SDCARD Bootloader Applications",
    "title": "SDCARD Bootloader Applications",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) # MPLAB® Harmony 3 SDCARD Bootloader Application Examples MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 SDCARD Bootloader application examples - [Release Notes](/bootloader_apps_sdcard/release_notes.html) - [MPLAB® Harmony License](/bootloader_apps_sdcard/mplab_harmony_license.html) To clone or download these application from Github,go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_sdcard) and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following [these instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki) ## Contents Summary | Folder | Description | --- | --- | apps | SDCARD Bootloader example applications | docs | Applications help documentation | ## Bootloader Examples The following applications are provided to demonstrate the SDCARD bootloader | Name | Description | --------- | ----------- | [SDCARD Bootloader](/bootloader_apps_sdcard/apps/sdcard_bootloader/readme.html) | This example application shows how to use the Bootloader Library to bootload an application using SDCARD protocol | ## Bootloader Library Refer to [Bootloader Library Help](https://microchip-mplab-harmony.github.io/bootloader) for understanding - Bootloader framework - How the Bootloader library works - Bootloader library configurations - Bootloader memory layout ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_sdcard/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_sdcard/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_sdcard/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_sdcard/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/bootloader_apps_sdcard.svg?style=social)]() ",
    "url": "http://localhost:4000/bootloader_apps_sdcard/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "bootloader_apps_sdcard";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "SDCARD Bootloader Applications";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/bootloader_apps_sdcard/assets/css/just-the-docs-' + theme + '.css');
}
